                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="produk_kategori.php">Kategori</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                                                                    ...
                                                                                    <div class="quickview-content">
                                                                                        ...
                                                                                        <div class="add-to-cart">
                                                                                            <a href="keranjang_masukkan.php?id=<?php echo $dp['produk_id']; ?>&redirect=detail"
                                                                                                class="btn"
                                                                                                style="background: orange;color:white;">Add
                                                                                                to cart</a>
                                                                                        </div>
                                                                                        <div class="default-social">
                                                                                            ...
                                                                                            <ul>
                                                                                                <li><a class="facebook"
                                                                                                        href="https://www.facebook.com/pages/Rejiku-Store/545850239081789?locale=id_ID"><i
                                                                                                            class="fa fa-facebook"></i></a>
                                                                                                </li>
                                                                                                <li><a class="instagram"
                                                                                                        href="https://www.instagram.com/rejikustore/"><i
