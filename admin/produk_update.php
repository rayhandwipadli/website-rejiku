...
mysqli_query($koneksi, "update produk set produk_nama='$nama', produk_kategori='$kategori', produk_harga='$harga', produk_keterangan='$keterangan', produk_berat='$berat', produk_jumlah='$jumlah', produk_ukuran1='$ukuran1', produk_ukuran2='$ukuran2', produk_ukuran3='$ukuran3' where produk_id='$id'");
