    ...
    <section class="content">
        ...
        <div class="row">
            ...
            ?>
                    ...
                    <a href="produk.php" class="small-box-footer">Info Lanjut <i
            ...
            ?>
                    ...
                    <a href="customer.php" class="small-box-footer">Info Lanjut <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            ?>
                    ...
                    <a href="transaksi.php" class="small-box-footer">Info Lanjut <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            ?>
                        ...
                        <p>Jumlah Admin Rejiku Store</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-person-add"></i>
                    </div>
                    <a href="admin.php" class="small-box-footer">Info Lanjut <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="label label-success text-uppercase"><?php echo $_SESSION['status']; ?></span>
                                </td>
                            </tr>
                        </table>
                    </div>
