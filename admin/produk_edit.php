            ...
            <section class="col-lg-12">
                <div class="box box-dark">
                    ...
                    <div class="box-header">
                        ...
                        <a href="produk.php" class="btn btn-light btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp
                            Kembali</a>
                    </div>
                    <div class="box-body">
              ...
              ?>
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="ukuran1"
                                            placeholder="Masukkan Jumlah .."
                                            value="<?php echo $d['produk_ukuran1']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="ukuran2"
                                            placeholder="Masukkan Jumlah .."
                                            value="<?php echo $d['produk_ukuran2']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="ukuran3"
                                            placeholder="Masukkan Jumlah .."
                                            value="<?php echo $d['produk_ukuran3']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!-- tambahan ukuran stop-->
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-sm btn-dark" value="Simpan">
                            </div>
