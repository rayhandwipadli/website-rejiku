            ...
            <section class="col-lg-6 col-lg-offset-3">
                <div class="box box-dark">
                    ...
                    <div class="box-header">
                        ...
                        <a href="admin.php" class="btn btn-light btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp;
                            Kembali</a>
                    </div>
                    <div class="box-body">
                ...
                ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama"
                                    value="<?php echo $d['admin_nama'] ?>" required="required">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-sm btn-light" value="Simpan">
                            </div>
                            <?php
              }
