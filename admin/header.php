    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="index.php" class="logo">
                <span class="logo-mini"><b>Rejiku</b> store</span>
                <span class="logo-lg"><b>Rejiku</b> store</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            if($profil['admin_foto'] == ""){ 
              ?>
                        ...
                        <?php }else{ ?>
                        <img src="../gambar/user/<?php echo $profil['admin_foto'] ?>" class="img-circle"
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="transaksi.php">
                            <i class="fa fa-retweet"></i> <span>PESANAN</span>
                        </a>
                    </li>
