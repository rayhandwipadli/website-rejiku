                ...
                <div class="pull-left">
                    ...
                    <div class="header-logo">
                        <a class="logo" href="index.php">
                            <h2>Rejiku <span class="primary-color">Store.</span></h2>
                        </a>
                    </div>
                    <!-- /Logo -->
            ...
            <div id="responsive-nav">
                ...
                <div class="category-nav show-on-click">
                    ...
                    <ul class="category-list">
						...
						?>
                        <li style="background: #999;"><a href="produk.php" style="color: white">Tampilkan Semua</a></li>
                    </ul>
                </div>
                <!-- /category nav -->
